...
WriteGeoLayerToGeoJSON(GeoLayerID="StateHouseLegislativeDistrictsLayer",OutputFile="../data/co-state-house-districts-2021.geojson")
...
WriteGeoLayerToGeoJSON(GeoLayerID="StateSenateLegislativeDistrictsLayer",OutputFile="../data/co-state-senate-districts-2021.geojson")
